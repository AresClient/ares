...
object RenderUtil {
    ...
    object Fill {
        ...
        fun quad(pos1: Vector3f, pos2: Vector3f, pos3: Vector3f, pos4: Vector3f, color1: Color, color2: Color, color3: Color, color4: Color) = quad(pos1.x, pos1.y, pos1.z, pos2.x, pos2.y, pos2.z, pos3.x, pos3.y, pos3.z, pos4.x, pos4.y, pos4.z, color1, color2, color3, color4)
        ...
        fun quad(pos1: Vector3f, pos2: Vector3f, pos3: Vector3f, pos4: Vector3f, color: Color) = quad(pos1.x, pos1.y, pos1.z, pos2.x, pos2.y, pos2.z, pos3.x, pos3.y, pos3.z, pos4.x, pos4.y, pos4.z, color, color, color, color)
        ...
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, vararg excludedSides: Direction) {
            if(excludedSides.isEmpty()) {
                ...
                if(!excludedSides.contains(Direction.DOWN))    Renderer.getBuffers().triangle.indicesOffset(0,1,2, 2,3,0)
                if(!excludedSides.contains(Direction.WEST))    Renderer.getBuffers().triangle.indicesOffset(3,7,4, 4,0,3)
                if(!excludedSides.contains(Direction.EAST))    Renderer.getBuffers().triangle.indicesOffset(1,5,6, 6,2,1)
                if(!excludedSides.contains(Direction.NORTH))   Renderer.getBuffers().triangle.indicesOffset(0,4,5, 5,1,0)
                if(!excludedSides.contains(Direction.SOUTH))   Renderer.getBuffers().triangle.indicesOffset(2,6,7, 7,3,2)
                if(!excludedSides.contains(Direction.UP))      Renderer.getBuffers().triangle.indicesOffset(7,6,5, 5,4,7)
            }
        ...
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, excludedSides = excludedSides)
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, colorBottom: Color, colorTop: Color, vararg excludedSides: Direction) = box(minX, minY, minZ, maxX, maxY, maxZ, colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, excludedSides = excludedSides)
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, colorBottom: Color, colorTop: Color, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, excludedSides = excludedSides)
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, color: Color, vararg excludedSides: Direction) = box(minX, minY, minZ, maxX, maxY, maxZ, color, color, color, color, color, color, color, color, excludedSides = excludedSides)
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, color: Color, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), color, color, color, color, color, color, color, color, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, colorBottom: Color, colorTop: Color, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, colorBottom: Color, colorTop: Color, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, color: Color, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, color, color, color, color, color, color, color, color, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, color: Color, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), color, color, color, color, color, color, color, color, excludedSides = excludedSides)
        fun box(box: Box, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, excludedSides = excludedSides)
        fun box(box: Box, colorBottom: Color, colorTop: Color, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, excludedSides = excludedSides)
        fun box(box: Box, color: Color, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), color, color, color, color, color, color, color, color, excludedSides = excludedSides)
    }
    ...
    object Lines {
        ...
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, width: Float, vararg excludedSides: Direction) {
            if(excludedSides.isEmpty()) {
                Renderer.getBuffers().lines.indicesOffset(
                    0, 4,
                    1, 5,
        ...
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, weight: Float, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, weight, excludedSides = excludedSides)
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, colorBottom: Color, colorTop: Color, weight: Float, vararg excludedSides: Direction) = box(minX, minY, minZ, maxX, maxY, maxZ, colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, weight, excludedSides = excludedSides)
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, colorBottom: Color, colorTop: Color, weight: Float, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, weight, excludedSides = excludedSides)
        fun box(minX: Float, minY: Float, minZ: Float, maxX: Float, maxY: Float, maxZ: Float, color: Color, weight: Float, vararg excludedSides: Direction) = box(minX, minY, minZ, maxX, maxY, maxZ, color, color, color, color, color, color, color, color, weight, excludedSides = excludedSides)
        fun box(minX: Double, minY: Double, minZ: Double, maxX: Double, maxY: Double, maxZ: Double, color: Color, weight: Float, vararg excludedSides: Direction) = box(minX.toFloat(), minY.toFloat(), minZ.toFloat(), maxX.toFloat(), maxY.toFloat(), maxZ.toFloat(), color, color, color, color, color, color, color, color, weight, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, weight, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, weight, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, colorBottom: Color, colorTop: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, weight, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, colorBottom: Color, colorTop: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, weight, excludedSides = excludedSides)
        fun box(minPos: Vector3f, maxPos: Vector3f, color: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x, minPos.y, minPos.z, maxPos.x, maxPos.y, maxPos.z, color, color, color, color, color, color, color, color, weight, excludedSides = excludedSides)
        fun box(minPos: Vec3d, maxPos: Vec3d, color: Color, weight: Float, vararg excludedSides: Direction) = box(minPos.x.toFloat(), minPos.y.toFloat(), minPos.z.toFloat(), maxPos.x.toFloat(), maxPos.y.toFloat(), maxPos.z.toFloat(), color, color, color, color, color, color, color, color, weight, excludedSides = excludedSides)
        fun box(box: Box, color: Color, colorX: Color, colorXZ: Color, colorZ: Color, colorY: Color, colorXY: Color, colorXYZ: Color, colorYZ: Color, weight: Float, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), color, colorX, colorXZ, colorZ, colorY, colorXY, colorXYZ, colorYZ, weight, excludedSides = excludedSides)
        fun box(box: Box, colorBottom: Color, colorTop: Color, weight: Float, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), colorBottom, colorBottom, colorBottom, colorBottom, colorTop, colorTop, colorTop, colorTop, weight, excludedSides = excludedSides)
        fun box(box: Box, color: Color, weight: Float, vararg excludedSides: Direction) = box(box.minX.toFloat(), box.minY.toFloat(), box.minZ.toFloat(), box.maxX.toFloat(), box.maxY.toFloat(), box.maxZ.toFloat(), color, color, color, color, color, color, color, color, weight, excludedSides = excludedSides)
    }
}
