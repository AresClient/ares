...
class AresTitleScreen: ScreenElement("Ares Title Screen") {
    companion object: Wrapper {
        ...
        private val LOGO_FG =
            Texture(this::class.java.getResourceAsStream("/assets/ares/textures/icons/ares_fg.png"))
        ...
        private val MINECRAFT_BUTTON = IconButton(
            Texture(this::class.java.getResourceAsStream("/assets/ares/textures/icons/minecraft.png")),
            5f, 5f, 30f, 30f
        ) {
