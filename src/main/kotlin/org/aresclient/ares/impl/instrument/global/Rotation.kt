...
object Rotation: Global.PriorityHandler<Rotator>("Rotation", "Handles rotation so that the character is facing in the expected direction for an action."), CameraAdjustor {
    ...
    @field:EventHandler
    private val changeLookDirection = EventListener<PlayerEvent.ChangeLookDirection> { event ->
    ...
    @field:EventHandler
    private val updateVelocityYaw = EventListener<PlayerEvent.UpdateVelocityYaw> { event ->
