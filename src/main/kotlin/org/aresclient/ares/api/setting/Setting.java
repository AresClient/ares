...
public class Setting<T> {
	...
	public enum Type {
		STRING, BOOLEAN, ENUM, COLOR, BIND,
	...
	Setting(ISerializer<?> serializer, Type type, T value) {
		this.serializer = serializer; this.type = type; this.value = value;
	}
	...
	public java.lang.String getName() {
		if (getParent() instanceof Setting.List<?>) return java.lang.String.valueOf(((List<?>) getParent()).indexOf(this));
		return name;
	}
	...
	public Setting<T> setDescription(java.lang.String... lines) {
		this.description = lines; return this;
	}
	...
	public Setting<T> setVisibility(Supplier<java.lang.Boolean> hidden) {
		this.visible = hidden; return this;
	}
	...
	public Setting<T> removeListener(Consumer<T> listener) {
		listeners.remove(listener); return this;
	}
	...
	public void setValue(T value) {
		T prev = this.value; this.value = value; if (prev != value) for (Consumer<T> consumer : listeners) {
			consumer.accept(value);
		}
	}

	public java.lang.String getPath() {
		java.lang.String prefix = null; if (getParent() != null) prefix = getParent().getPath();
	...
	public static class ReadInfo<T> {
		...
		ReadInfo(Type type, Type elementType, T defaultValue) {
			this.type = type; this.elementType = elementType; this.defaultValue = defaultValue;
		}
		...
		public ReadInfo<T> setEnumClass(Class<? extends java.lang.Enum> enumClass) {
			this.enumClass = enumClass; return this;
		}
		...
		public ReadInfo<T> setRainbow(boolean rainbow) {
			this.rainbow = rainbow; return this;
		}
	...
	public static class Enum<T extends java.lang.Enum<?>> extends Setting<T> {
		...
		public Enum<T> addRestriction(T value, Supplier<java.lang.Boolean> restrictor, java.lang.String errorMessage) {
			restrictions.put(value, new Pair<>(restrictor, errorMessage)); return this;
		}
	}
	...
	public static class Color extends Setting<org.aresclient.ares.api.util.Color> {
		...
		public Color(ISerializer<?> serializer, org.aresclient.ares.api.util.Color value, boolean rainbow) {
			super(serializer, Type.COLOR, value); this.rainbow = rainbow;
		}
		...
		@Override public org.aresclient.ares.api.util.Color getValue() {
			return rainbow
						 ? org.aresclient.ares.api.util.Color.rainbow().deriveAlpha(super.getValue().getAlpha())
						 : super.getValue();
		}

		@Override public void setDefault() {
			setRainbow(getReadInfo().isRainbow()); super.setDefault();
		}
	...
	public static class Bind extends Setting<java.lang.Integer> {
		...
		public Bind(ISerializer<?> serializer, java.lang.Integer value) {
			super(serializer, Type.BIND, value); BINDS.add(this);
		}
		...
		public Bind setCallback(Consumer<java.lang.Boolean> callback) {
	...
	public static class Number<T extends java.lang.Number> extends Setting<T> {
		...
		public Number<T> setDescription(java.lang.String... line) {
			super.setDescription(line); return this;
		}
		...
		public Number<T> setPrecision(java.lang.Integer precision) {
			if (this.getValue() instanceof java.lang.Double
					|| this.getValue() instanceof java.lang.Float
					|| this.getValue() instanceof java.lang.Integer) this.precision = precision; return this;
		}
	}


	public static class Short extends Number<java.lang.Short> {
		public Short(ISerializer<?> serializer, java.lang.Short value) {
			super(serializer, Type.SHORT, value);
		}
	}


	public static class Integer extends Number<java.lang.Integer> {
		public Integer(ISerializer<?> serializer, java.lang.Integer value) {
			super(serializer, Type.INTEGER, value);
		}

		@Override public void setValue(java.lang.Integer value) {
			if (getPrecision() != null) {
				int scale = (int) Math.pow(10, getPrecision()); value = (int) (Math.round(value.doubleValue() / scale) * scale);
			}
	...
	public static class Long extends Number<java.lang.Long> {
	...
	public static class Float extends Number<java.lang.Float> {
		...
		@Override public void setValue(java.lang.Float value) {
			if (getPrecision() != null) {
				int scale = (int) Math.pow(10, getPrecision()); value = (float) (Math.round(value * scale) / scale);
			}
	...
	public static class Double extends Number<java.lang.Double> {
		...
		@Override public void setValue(java.lang.Double value) {
			if (getPrecision() != null) {
				int scale = (int) Math.pow(10, getPrecision()); value = (double) (Math.round(value * scale) / scale);
			}
	...
	public static class List<T extends Setting<?>> extends Setting<T[]> {
		public List(ISerializer<?> serializer, T[] value) {
			super(serializer, Type.LIST, value); for (T setting : value) setting.setParent(this);
		}

		public void add(T setting) {
			setting.setParent(this);

			T[] prev = getValue(); Setting<?>[] value = new Setting[prev.length + 1];

			System.arraycopy(prev, 0, value, 0, prev.length); value[prev.length] = setting; setValue((T[]) value);
		}

		public void remove(int index) {
			T[] prev = getValue(); Setting<?>[] value = new Setting[prev.length - 1];

			int i = 0; for (; i < index; i++) value[i] = prev[i]; prev[i++].setParent(null);
		...
		public void remove(T setting) {
			int index = indexOf(setting); if (index != -1) remove(index);
		}
	...
	public static class Map<R> extends Setting<java.util.Map<java.lang.String, Setting<?>>> {
		...
		Map(ISerializer<R> serializer,
				java.util.Map<java.lang.String, R> data,
				java.util.Map<java.lang.String, Setting<?>> value)
		{
			super(serializer, Type.MAP, value); this.data = data;
		}
		...
		public <T, S extends Setting<T>> S add(ReadInfo<T> readInfo, java.lang.String name, java.lang.String... description) {
			...
			if (prev != null) {
				assert prev.getReadInfo().getType() == readInfo.getType(); return (S) prev;
			}

			S setting = (S) ((ISerializer<R>) getSerializer()).read(readInfo, data.get(name)); setting.setParent(this);
			setting.setName(name); setting.setReadInfo(readInfo); setting.setDescription(description);
			getValue().put(name, setting); return setting;
		}

		public String addString(java.lang.String name, java.lang.String defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.STRING, defaultValue), name, description);
		}

		public Boolean addBoolean(java.lang.String name, boolean defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.BOOLEAN, defaultValue), name, description);
		}

		public <T extends java.lang.Enum<?>> Enum<T> addEnum(java.lang.String name,
																												 T defaultValue,
		...
		public Color addColor(java.lang.String name,
													org.aresclient.ares.api.util.Color defaultValue,
													boolean rainbow,
													java.lang.String... description)
		{
		...
		public Bind addBind(java.lang.String name, int defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.BIND, defaultValue), name, description);
		}

		public Short addShort(java.lang.String name, short defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.SHORT, defaultValue), name, description);
		}

		public Integer addInteger(java.lang.String name, int defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.INTEGER, defaultValue), name, description);
		}

		public Long addLong(java.lang.String name, long defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.LONG, defaultValue), name, description);
		}

		public Float addFloat(java.lang.String name, float defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.FLOAT, defaultValue), name, description);
		}

		public Double addDouble(java.lang.String name, double defaultValue, java.lang.String... description) {
			return add(new ReadInfo<>(Type.DOUBLE, defaultValue), name, description);
		}

		public <T extends Setting<?>> List<T> addList(Type elementType,
		...
		public <T extends Enum<?>> List<T> addEnumList(Type elementType,
		...
		public <T extends Enum<?>> List<T> addEnumList(Type elementType,
																									 ...
																									 java.lang.String... description)
		{
			return addEnumList(elementType, enumClass, name, (T[]) new Enum[] {}, description);
		}

		public Map<R> addMap(java.lang.String name, java.lang.String... description)
		{
			return add(new ReadInfo<>(Type.MAP, new HashMap<>()), name, description);
		}

		public <T extends Grouped.Trait, S extends java.lang.Enum<?>> Grouped<T, S> addGrouped(java.lang.String name,
																																													 java.lang.String[] description,
																																													 Class<T> traitClass,
																																													 Class<S> enumClass,
																																													 Grouped.Initializer<T, S>... defaultGroups)
		{
			Grouped<T, S> grouped = new Grouped<>(this, name, description, traitClass, enumClass, defaultGroups);
			getValue().put(name, new Setting<>(getSerializer(), Type.GROUPED, grouped)); return grouped;
		}
