...
abstract class Module(
    ...
    companion object {
        val SETTINGS = org.aresclient.ares.Ares.SETTINGS.category("Modules")
        ...
        val MC = Ares.INSTANCE.minecraft
    }
    ...
    init {
        org.aresclient.ares.Ares.MODULES.add(this)
        category.modules.add(this)
        if(shouldTick()) Ares.EVENT_MANAGER.register(this.javaClass)
    }
