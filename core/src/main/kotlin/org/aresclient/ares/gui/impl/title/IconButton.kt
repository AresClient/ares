...
class IconButton(private val texture: Texture, x: Float, y: Float, width: Float, height: Float,
    ...
    override fun draw(theme: Theme, buffers: Renderer.Buffers, matrixStack: MatrixStack, mouseX: Int, mouseY: Int) {
        ...
        buffers.ellipse.draw(matrixStack) {
            vertices(
                1f, 1f, 0f, 1f, 1f, theme.primary.red, theme.primary.green, theme.primary.blue, theme.primary.alpha,
                1f, 0f, 0f, 1f, -1f, theme.primary.red, theme.primary.green, theme.primary.blue, theme.primary.alpha,
                0f, 1f, 0f, -1f, 1f, theme.primary.red, theme.primary.green, theme.primary.blue, theme.primary.alpha,
                0f, 0f, 0f, -1f, -1f, theme.primary.red, theme.primary.green, theme.primary.blue, theme.primary.alpha,

                1f - BORDER, 1f - BORDER, 0f, 1f, 1f, theme.secondary.red, theme.secondary.green, theme.secondary.blue, theme.secondary.alpha,
                1f - BORDER, BORDER, 0f, 1f, -1f, theme.secondary.red, theme.secondary.green, theme.secondary.blue, theme.secondary.alpha,
                BORDER, 1f - BORDER, 0f, -1f, 1f, theme.secondary.red, theme.secondary.green, theme.secondary.blue, theme.secondary.alpha,
                BORDER, BORDER, 0f, -1f, -1f, theme.secondary.red, theme.secondary.green, theme.secondary.blue, theme.secondary.alpha
            )
            indices(
                0, 1, 2,
                1, 2, 3,
            ...
            if(hovering || holding) {
                ...
                vertices(
                    1f - BORDER - offset, 1f - BORDER - offset, 0f, 1f, 1f, theme.primary.red, theme.primary.green, theme.primary.blue, 0.6f,
                    1f - BORDER - offset, BORDER + offset, 0f, 1f, -1f, theme.primary.red, theme.primary.green, theme.primary.blue, 0.6f,
                    BORDER + offset, 1f - BORDER - offset, 0f, -1f, 1f, theme.primary.red, theme.primary.green, theme.primary.blue, 0.6f,
                    BORDER + offset, BORDER + offset, 0f, -1f, -1f, theme.primary.red, theme.primary.green, theme.primary.blue, 0.6f
                )
                indices(
                    8, 9, 10,
                    9, 10, 11
