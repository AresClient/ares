...
/**
 * @author Tigermouthbear 3/5/22
 * Provides the keycodes that mesh uses and utility for them
 */
public class Keys {
    ...
    public static String getName(int key) {
        return nameMap.getOrDefault(key, "UNKNOWN");
    }

    public static int getKey(String name) {
        return keyMap.getOrDefault(name, UNKNOWN);
    }
}
