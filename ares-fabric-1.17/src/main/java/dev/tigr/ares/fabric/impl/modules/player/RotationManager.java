...
public class RotationManager extends Module {
    ...
    public static Vec2f getPlaceSideAngle(BlockPos pos) {
        ...
        return new Vec2f(SelfUtils.getPlayer().getYaw() + MathHelper.wrapDegrees(yaw - SelfUtils.getPlayer().getYaw()), SelfUtils.getPlayer().getPitch() + MathHelper.wrapDegrees(pitch - SelfUtils.getPlayer().getPitch()));
    }
}
